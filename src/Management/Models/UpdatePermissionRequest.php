 ...
 * rule 5).
 */
final class UpdatePermissionRequest implements \JsonSerializable
{
    /**
     * Constructs a UpdatePermissionRequest.
     * @param string|null $action the server's `action` field (optional)
    ...
    /**
     * Rebuilds a UpdatePermissionRequest from one decoded JSON object.
