...
{
    /**
     * Constructs a UpdateResourceRequest.
     ...
     * @param string|null $resourceType the server's `resource_type` field (optional)
     */
    ...
    /**
     * Rebuilds a UpdateResourceRequest from one decoded JSON object.
