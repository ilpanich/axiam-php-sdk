 ...
 */
final class OidcAuthorizeResponse implements \JsonSerializable
{
    /**
     * Constructs a OidcAuthorizeResponse.
     * @param string $url The full authorization URL to redirect the user to.
     */
    ...
    /**
     * Rebuilds a OidcAuthorizeResponse from one decoded JSON object.
