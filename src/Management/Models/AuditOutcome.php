...
{
    /** The wire value `Success`. */
    case Success = 'Success';

    /** The wire value `Failure`. */
    case Failure = 'Failure';

    /** The wire value `Denied`. */
    case Denied = 'Denied';

    /**
     * Parses a wire value into a AuditOutcome.
     *
    ...
    public static function fromWire(string $value): self
    {
        return self::tryFrom($value) ?? throw new \Axiam\Sdk\Core\AxiamException(
            sprintf('unknown AuditOutcome value "%s" — the server may be newer than this SDK', $value),
        );
    }
}
