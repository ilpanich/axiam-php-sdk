...
{
    /**
     * Constructs a UpdateUserRequest.
     * @param string|null $email the server's `email` field (optional)
     * @param mixed $metadata the server's `metadata` field (optional)
     * @param UserStatus|null $status the server's `status` field (optional)
     * @param string|null $username the server's `username` field (optional)
     */
    ...
    /**
     * Rebuilds a UpdateUserRequest from one decoded JSON object.
