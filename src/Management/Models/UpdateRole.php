 ...
 * rule 5).
 */
final class UpdateRole implements \JsonSerializable
{
    /**
     * Constructs a UpdateRole.
     * @param string|null $description the server's `description` field (optional)
     * @param bool|null $isGlobal the server's `is_global` field (optional)
    ...
    /**
     * Rebuilds a UpdateRole from one decoded JSON object.
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            isset($data['is_global']) ? (bool) $data['is_global'] : null,
