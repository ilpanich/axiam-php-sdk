 ...
 */
final class ServiceAccountCreatedResponse implements \JsonSerializable
{
    /**
     * Constructs a ServiceAccountCreatedResponse.
    ...
    /**
     * Rebuilds a ServiceAccountCreatedResponse from one decoded JSON object.
