 ...
 */
final class GeneratedPgpKey implements \JsonSerializable
{
    /**
     * Constructs a GeneratedPgpKey.
     ...
     * @param \Axiam\Sdk\Core\Sensitive|null $privateKeyArmored ASCII-armored private key —
     *     returned only on generation for `Export` keys. For `AuditSigning` keys this is `None`
     *     (private key is server-side only). (optional)
     */
    public function __construct(
        ...
        public readonly ?\Axiam\Sdk\Core\Sensitive $privateKeyArmored = null,
    ) {
    }

    /**
     * Rebuilds a GeneratedPgpKey from one decoded JSON object.
    ...
    public function toArray(): array
    {
        ...
        if ($this->privateKeyArmored !== null) {
            $out['private_key_armored'] = $this->privateKeyArmored;
        }
