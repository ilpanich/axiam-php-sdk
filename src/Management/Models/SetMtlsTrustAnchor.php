 ...
 */
final class SetMtlsTrustAnchor implements \JsonSerializable
{
    /**
     * Constructs a SetMtlsTrustAnchor.
     * @param bool $enabled Whether this CA should be trusted for client-certificate
     *     authentication.
     */
    ...
    /**
     * Rebuilds a SetMtlsTrustAnchor from one decoded JSON object.
