...
final class OAuth2ClientResponse implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            (bool) ModelDecode::need($data, 'require_par', self::class),
            array_values(array_map(static fn (mixed $v): string => (string) $v, (array) ModelDecode::need($data, 'scopes', self::class))),
            array_values(array_map(static fn (mixed $v): string => (string) $v, (array) ModelDecode::need($data, 'self_signed_tls_client_auth_thumbprints', self::class))),
