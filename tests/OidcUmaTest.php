 ...
 * exchange has already spent it — and under concurrency a retry is precisely the second
 * redemption whose measured residual ilpanich/axiam#302 records. "Exactly one request" is
